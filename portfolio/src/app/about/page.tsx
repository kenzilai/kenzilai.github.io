export default function About() {
    return (
        <section id="about" className="container mx-auto px-20 pt-20">
            ...
            <main className="py-5 text-xl">
                ...
                <br />
                <p>
                    <b>But I didn't stop there.</b>
                </p>
                <br />
                <p>
                    Recognizing that just the passion and knowledges in Computer
                ...
                <br />
                <p>
                    Being able to code has enabled me to pursue my interests in
                    Web Development and contribute to Open Source projects while
                    applying my passion to Game development.
                </p>
                <br />
                <p>
                    As you explore my website, I hope you will gain insight into
                    who I am and the passion I bring to my work.
                </p>
            </main>
        </section>
    );
